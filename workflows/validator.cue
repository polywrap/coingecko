...
coins_list: {
	$0: {
		data: '[ { "id": "bitcoin", "symbol": "btc", "name": "Bitcoin" }, { "id": "litecoin", "symbol": "ltc", "name": "Litecoin" }, { "id": "auroracoin", "symbol": "aur", "name": "Auroracoin" }, { "id": "peercoin", "symbol": "ppc", "name": "Peercoin" }, { "id": "dogecoin", "symbol": "doge", "name": "Dogecoin" }, { "id": "nxt", "symbol": "nxt", "name": "NXT" }, { "id": "omni", "symbol": "omni", "name": "Omni (Mastercoin)" } ]'
	}
}
coins_markets: {
	$0: {
...
coins_tickers: {
	$0: {
		data: '{"name": "Bitcoin", "tickers": [{"base": "BTC", "target": "USDT", "market": {"name": "BW.com", "identifier": "bw", "has_trading_incentive": False}, "last": 7963.0, "    volume": 93428.7568, "converted_last": {"btc": 0.99993976, "eth": 31.711347, "usd": 7979.23}, "converted_volume": {"btc": 93423, "eth": 2962752, "usd": 745489919}, "    bid_ask_spread_percentage": 0.111969, "timestamp": "2019-05-24T11:20:14+00:00", "is_anomaly": False, "is_stale": False, "trade_url": "https://www.bw.com/trade/btc_us    dt", "coin_id": "bitcoin"}]}'
	}
}
coins_history: {
	$0: {
		data: '{"id":"bitcoin","symbol":"btc","name":"Bitcoin","localization":{"en":"Bitcoin","es":"Bitcoin","de":"Bitcoin","nl":"Bitcoin","pt":"Bitcoin","fr":"Bitcoin","it":"Bitcoin","hu":"Bitcoin","ro":"Bitcoin","sv":"Bitcoin","pl":"Bitcoin","id":"Bitcoin","zh":"比特币","zh-tw":"比特幣","ja":"ビットコイン","ko":"비트코인","ru":"биткоина","ar":"بيتكوين","th":"บิตคอยน์","vi":"Bitcoin","tr":"Bitcoin"},"image":{},"market_data":{}}'
	}
}
coins_market_chart: {
	$0: {
		data: '{"prices":[[1535373899623,6756.942910425894],[1535374183927,6696.894541693875]],"market_caps":[[1661233050566,405502229003.07416],[1661233320051,402816178851.15234]],"total_volumes":[[1661233050566,29464092800.632126],[1661233320051,29641850808.354652]]}'
	}
}
...
coins_contract: {
	$0: {
		data: '{"id": "0x", "symbol": "zrx", "name": "0x", "block_time_in_minutes": 0, "categories": ["Protocol"], "localization": {"en": "0x", "es": "0x", "de": "0x", "nl": "0x", "pt": "0x", "fr": "0x", "it": "0x", "hu": "0x", "ro": "0x", "sv": "0x", "pl": "0x", "id": "0x", "zh": "0x协议", "zh-tw": "0x協議", "ja": "ロエックス", "ko": "제로엑스", "ru": "0x", "ar": "0x", "th": "0x", "vi": "0x", "tr": "0x"}}'
	}
}
...
derivatives_exchanges: {
	$0: {
		data: '[ { "name": "Binance (Futures)", "id": "binance_futures", "open_interest_btc": 359829.78, "trade_volume_24h_btc": "2753089.25", "number_of_perpetual_pairs": 223, "number_of_futures_pairs": 31, "image": "https://assets.coingecko.com/markets/images/466/small/binance_futures.jpg?1568609512", "year_established": 2019, "country": null, "description": "", "url": "https://www.binance.com/" }]'
	}
}
...
derivatives_exchanges_list: {
	$0: {
		data: '[ { "id": "binance_futures", "name": "Binance (Futures)" }, { "id": "ftx", "name": "FTX (Derivatives)" }, { "id": "btcex_futures", "name": "BTCEX (Futures)" }, { "id": "btcc_futures", "name": "BTCC Futures" }]'
	}
}
search_trending: {
	$0: {
...
global: {
	$0: {
		data: '{ "data": { "active_cryptocurrencies": 2517, "upcoming_icos": 360, "ongoing_icos": 423, "ended_icos": 2037, "markets": 197 } }'
	}
}
global_decentralized_finance_defi: {
	$0: {
		data: '{ "data": { "defi_market_cap": "42767497270.4113144203703655612", "eth_market_cap": "189347527014.1116969754989548962", "defi_to_eth_ratio": "22.5867736140139487385112577510181708860308250510389555786051855", "trading_volume_24h": "3512459509.6853098597996719551", "defi_dominance": "4.0700711962266168254052764615574500681612867123435944765974882", "top_coin_name": "Lido Staked Ether", "top_coin_defi_dominance": 15.367284694973185 } }'
	}
}
companies_public_treasury: {
	$0: {
		data: '{ "total_holdings": 174374.4658, "total_value_usd": 3671364607.809375, "market_cap_dominance": 0.91, "companies": [{ "name": "Coinbase", "symbol": "NASDAQ: COIN", "country": "US", "total_holdings": 9000, "total_entry_value_usd": 173700000, "total_current_value_usd": 189490366, "percentage_of_total_supply": 0.043 }]'
	}
}
